					...
					<nav class="navbar navbar-default" data-spy="affix" data-offset-top="40">
					  <div class="container cnt">
					    ...
					    <div class="navbar-header">
					      ...
					      <a class="navbar-brand" href="#"><img src="img/site-icon.png" alt="Question Bank"></a>
					    </div>
									...
									@if(count($result)>0)
										...
										@foreach($result as $rs)
											...
											<div style="text-align: justify;">
												<h5>{!! $rs->uploader !!}</h5>
												<p>{!! $rs->created_at !!}</p>
												<div id="qst">{!! $rs->question !!}</div>
											</div>

											<form action="">
												<textarea class="form-control" name="qans" id="" rows="3" style="resize: none;">
						...
						<div class="col-md-12 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 col-xs-12" style="padding-left: 4px;">
									...
									<a href="#"><img src="img/site-icon.png" alt=""></a>
								...
								<div class="col-md-8">
									<div class="col-md-12 col-xs-12 clsm">
										<div class="row">
											<div class="col-md-6 col-xs-12 clsm footer_menu">
												<ul>
													<li>quick links
														<hr align="left">
													</li>
